...
class BasePlot(ABC):
    ...
    @abstractmethod
    def _setup_layout(self, **layout_args):
        pass
    @abstractmethod
    ...
    def add(self, stream, show:bool=None, **layout_args):
        if stream:
            ...
            stream_plot.trace_id = len(self.figwig.data)
            ...
            self._setup_layout(stream_plot, **layout_args)
    ...
    def _add_eval_result(self, stream_event:StreamEvent):
        ...
        if stream_event.event_type == StreamEvent.Type.reset:
            ...
            if stream_plot.throttle is None or stream_plot.last_update is None or \
                ...
                vals = BasePlot._process_eval_result(stream_plot, eval_result)
                if vals is not None:
